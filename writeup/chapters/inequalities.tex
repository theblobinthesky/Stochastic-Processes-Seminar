...
\begin{theorem}[Jensen's Inequality]
    ...
    \begin{enumerate}
        ...
        \item If the $f$ is strictly convex and $\mathbb{E} f(X) = f(\mathbb{E} X)$, we have $\mathbb{E}(X) = X$ almost surely.
    \end{enumerate}
\end{theorem}
\begin{proof}
    \begin{enumerate}
        ...
        \item
            ...
            But equality holds, so all prob. mass must be concentrated in one value.
    \end{enumerate}
\end{proof}
...
\begin{proof}
    \begin{enumerate}
        ...
        \item 
            ...
            \begin{align*}
                -D(p(x) \| q(x)) &= -\mathbb{E}_{p}\paren{\log \frac{p(X)}{q(X)}}
                = \mathbb{E}_{p}\paren{\log \frac{q(X)}{p(X)}}                          && \text{(def. of relative entropy)}            \\
                &\le \log\paren{\mathbb{E}_{p} \frac{q(X)}{p(X)}} \\
...
\begin{remark}
    ...
    \begin{enumerate}
        ...
        \item What distribution maximises the value of Entropy? \\
            ...
            \[
                \max_{p \in \mathbb{R}^{n}, \|p\|_1=1, p \le 0}{H(X_p)}
            \]
...
\begin{proof}
    \begin{enumerate}
        ...
        \item
            ...
            \begin{align*}
                0 &\le D(p(x) \| q(x))
                = \mathbb{E}_{p}\paren{\log \frac{p(X)}{q(X)}}
        ...
        \item
            We have $H(Y \mid X) = -\mathbb{E}\paren{\log p_{Y \mid X}(Y \mid X)} = \sum_{(x, y) \injoint}{-p_{X,Y}(x, y) \log p_{Y \mid X}(y \mid x)}$. \\
        ...
        \item
            We have
            \begin{align*}
                 H(Z \mid X) &= -\mathbb{E}\paren{\log p_{Z \mid X}(Z \mid X)} = \sum_{(x, y) \injoint}{-p_{X,Y}(x, y) \log \prob[Z = x + y \mid X = x]} \\
                 &= \sum_{(x, y) \injoint}{-p_{X,Y}(x, y) \log \prob[X + Y = x + y \mid X = x]} \\
                 &= \sum_{(x, y) \injoint}{-p_{X,Y}(x, y) \log \prob[Y = y \mid X = x]}
                 = -\mathbb{E}\paren{\log p_{Y \mid X}(Y \mid X)} = H(Y \mid X)
            \end{align*}
